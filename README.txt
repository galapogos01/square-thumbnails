...
We are working on the following features:
    * Options to select the image sizes for which to crate square thumbnails
    * Image alignment in the square
    * Choosing background color or texture/image/transparent
    * Editor with many features for image editing
